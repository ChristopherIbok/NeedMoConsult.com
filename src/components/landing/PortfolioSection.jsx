...
import { Play, ExternalLink, Eye, TrendingUp, Users, Heart } from "lucide-react";
...
const portfolioItems = [
  ...
  },
  {
    ...
    description: "Monthly content strategy with branded templates, photography, and cohesive feed aesthetics",
  ...
  },
  {
    ...
    description: "B2B content strategy for founder's personal brand and company page",
            ...
            {filteredItems.map((item, index) => (
              ...
              >
                ...
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-[#1A2332]/90 via-[#1A2332]/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {Object.entries(item.results).map(([key, value]) => (
                        <span key={key} className="text-xs bg-white/20 text-white px-2 py-1 rounded">
                          {value} {key}
                        </span>
                      ))}
                    </div>
                  ...
                  {item.featured && (
                    <Badge className="absolute top-4 left-4 bg-[#D4AF7A] text-[#1A2332] font-semibold">
                      Featured Project
                    </Badge>
                  )}
