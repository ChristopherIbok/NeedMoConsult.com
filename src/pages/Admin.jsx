      ...
      <div className="flex min-h-screen">
        ...
        <div className="w-64 bg-[#1A2332] flex flex-col min-h-screen fixed left-0 top-0 bottom-0 z-40">
          ...
          <div className="px-6 py-6 border-b border-white/10">
            <img
              src="https://qemjyupxlivyylpbnsjo.supabase.co/storage/v1/object/public/assets/Logo-Light.webp?V=3V=3V=3"
              alt="NEEDMO CONSULT"
    ...
    <div style={{ fontFamily: G, backgroundColor: "#E8E6E1", padding: "32px 16px" }}>
      <div style={{ maxWidth: 580, margin: "0 auto", backgroundColor: "#fff" }}>
        ...
        <div style={{ backgroundColor: "#1A2332", padding: "18px 32px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <img src="https://qemjyupxlivyylpbnsjo.supabase.co/storage/v1/object/public/assets/Logo-Light.webp?V=3V=3V=2" alt="NEEDMO" height={28} style={{ height: 28 }} />
        ...
        <div style={{ borderTop: "1px solid #EEEBE5", backgroundColor: "#F9F7F4", padding: "28px 32px", textAlign: "center" }}>
          <img src="https://qemjyupxlivyylpbnsjo.supabase.co/storage/v1/object/public/assets/Logo-Dark.webp?V=2" alt="NEEDMO" height={22} style={{ display: "block", margin: "0 auto 6px", height: 22 }} />
