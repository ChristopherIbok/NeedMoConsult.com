    ...
    <tr><td>
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#F9F7F4;">
        <tr><td style="padding:32px 40px;" align="center">
          <img src="https://qemjyupxlivyylpbnsjo.supabase.co/storage/v1/object/public/assets/Logo-Dark.webp?V=7?V=6?V=5?V=4" alt="NEEDMO CONSULT" height="56" style="display:block;margin:0 auto 8px;height:56px;width:auto;border:0;"/>
