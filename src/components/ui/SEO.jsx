...
export default function SEO({
  ...
  useEffect(() => {
    ...
    const ogImage   = (typeof image === "string" && image)
      ? image
      : "https://qemjyupxlivyylpbnsjo.supabase.co/storage/v1/object/public/assets/Logo-Dark.webp?V=5";
    ...
    const schema = {
      ...
      "publisher": {
        ...
        "logo": {
          "@type": "ImageObject",
          "url": "https://qemjyupxlivyylpbnsjo.supabase.co/storage/v1/object/public/assets/Logo-Dark.webp?V=5"
        }
      },
