      ...
      <div className="relative max-w-4xl mx-auto px-5 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <Link to={createPageUrl("Contact")} className="block sm:inline-block">
            <Button
              size="lg"
              className="w-full sm:w-auto bg-white text-[#1A2332] hover:bg-gray-100 active:scale-[0.98] font-bold px-8 sm:px-10 py-5 text-base sm:text-lg transition-all min-h-[56px]"
            >
