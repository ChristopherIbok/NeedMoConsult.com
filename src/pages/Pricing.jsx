...
const faqs = [
  {
    ...
    answer:
      "We manage all major social platforms including Instagram, Facebook, TikTok, LinkedIn, Twitter/X, YouTube, and Pinterest. The number of platforms depends on your chosen package.",
  },
  {
    question: "How long are your contracts?",
    answer:
      "We offer flexible month-to-month agreements after an initial 3-month commitment. This allows enough time to build momentum and see real results.",
  },
  {
    question: "What if I need something not included in a package?",
    answer:
      "We're happy to create custom packages! Contact us to discuss your specific needs and we'll build a solution that fits.",
  },
  {
    question: "How do you measure results?",
    answer:
      "We track key metrics including engagement rate, follower growth, reach, website traffic, and conversions. You'll receive regular reports with clear insights.",
  },
  {
    question: "Can I upgrade or downgrade my package?",
    answer:
      "Absolutely! You can adjust your package at the start of any billing cycle. We'll help you find the right fit as your needs evolve.",
  },
  {
    question: "Do you require access to our accounts?",
    answer:
      "Yes, we need appropriate access to manage your accounts effectively. We use secure methods and can sign NDAs for sensitive accounts.",
  },
];
...
export default function Pricing() {
  ...
  return (
    <main className="pt-20">
      <SEO
        title="Pricing & Packages | NEEDMO CONSULT"
        ...
        canonical="https://needmoconsult.com/pricing"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-[#333333] dark:text-gray-400 mb-4">
              Choose a package that fits your goals. No hidden fees, no
              surprises.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <p className="text-[#333333] dark:text-gray-400 mb-2">
              Need something custom? Let's build a package that fits your exact
              needs.
            </p>
            <Link
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                <AccordionItem
                  value={`item-${index}`}
                  className="bg-white dark:bg-[#1E2830] rounded-xl px-6 border-none shadow-sm"
                >
                  <AccordionTrigger className="text-left font-semibold text-[#1A2332] dark:text-white hover:no-underline py-5">
                    {faq.question}
                  </AccordionTrigger>
                  <AccordionContent className="text-[#333333] dark:text-gray-400 pb-5">
                    {faq.answer}
                  </AccordionContent>
                </AccordionItem>
              </motion.div>
